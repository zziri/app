...
const dDayArticleList: Array<Article> = [
    ...
    contents: (
      <>
        <article>
          ...
          <br /><br />
          이 용어는 2차 세계 대전 동안 노르망디 상륙 작전의 날짜인 1944년 6월 6일과 가장 밀접하게 연관되어 있습니다. 당시 독일군에게 작전 날짜를 노출시키지 않기 위해 특정한 날짜 대신 'D-Day'라는 표현을 사용했다고 합니다.
          <br /><br />
  ...
  },
  {
    ...
    contents: (
      <>
        <article>
          날짜를 선택하거나 키보드로 yyyy-mm-dd 형식으로 입력하기만 하면 디데이 계산 결과가 '남은 일수' 필드에 노출됩니다.
          <br /><br />
